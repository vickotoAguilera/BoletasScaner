    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-[#00d4aa]/10 to-[#0a0a0a] items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-2xl font-bold mb-4">Organiza tus gastos fácilmente</h2>
          <p className="text-gray-400">
            Escanea boletas con tu cámara y nuestra IA se encarga del resto. 
            Tus gastos organizados en segundos.
          </p>
        </div>
      </div>
    </div>
